...
export class PermissionEngine {
  static classifyAction(actionType: string): PermissionLevel {
    ...
    if (type === 'CREATE_TASK' || type === 'LOG_SESSION' || type === 'LOG_WORK_SESSION' || type === 'UPDATE_CAPACITY' || type === 'LOG_RECURRING' || type === 'CREATE_RECURRING' || type === 'CREATE_FIXED' || type === 'CREATE_VACATION') return 'SAFE'
